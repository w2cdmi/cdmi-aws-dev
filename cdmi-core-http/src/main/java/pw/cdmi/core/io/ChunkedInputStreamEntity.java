...
public class ChunkedInputStreamEntity extends BasicHttpEntity {
	protected static final Logger logger = LoggerFactory.getLogger(ChunkedInputStreamEntity.class);
    ...
    public ChunkedInputStreamEntity(ServiceClient.Request request) {
        ...
        try {
        	...
        	logger.error("Unable to parse content length from request.", nfe);
        }
    ...
    public static class ReleasableInputStreamEntity extends AbstractHttpEntity implements Releasable {
        ...
        private void doRelease() {
            try {
            	...
            	logger.error("Unexpected io exception when trying to close input stream", ex);
            }
        }

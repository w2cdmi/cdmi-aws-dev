...
import pw.cdmi.core.io.BoundedInputStream;
import pw.cdmi.core.io.RepeatableBoundedFileInputStream;
import pw.cdmi.core.io.RepeatableFileInputStream;
    ...
    public static InputStream newRepeatableInputStream(final InputStream original) throws IOException {
        ...
        if (!original.markSupported()) {
            if (original instanceof FileInputStream) {
                ...
                repeatable = new BufferedInputStream(original, Constants.DEFAULT_STREAM_BUFFER_SIZE);                
            }
        } else {
            repeatable = original;
        }

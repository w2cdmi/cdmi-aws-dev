...
import pw.cdmi.core.http.client.ClientErrorCode;
...
public class ExceptionFactory {
    ...
    public static ClientException createClientException(String requestId, String errorCode, Throwable cause) {
        return new ClientException(cause.getMessage(), errorCode, requestId, cause);
    }
    
    public static ServiceException createServiceException(String requestId, String errorCode, Throwable cause) {
        return new ServiceException(cause.getMessage(), errorCode, requestId, null,cause);
    }
}

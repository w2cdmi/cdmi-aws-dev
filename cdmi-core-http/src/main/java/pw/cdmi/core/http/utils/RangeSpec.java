...
public class RangeSpec {
    ...
    public static RangeSpec parse(long[] range) {
        if (range == null || range.length != 2) {
        	logger.warn("Invalid range value " + range + ", ignore it and just get entire object");
        }
        ...
        if (start < 0 && end < 0 ||
        	...
        	logger.warn("Invalid range value [" + start + ", " + end + "], ignore it and just get entire object");
        }
